...
namespace WpfApp1
{
    public class DummyData
    {
        ...
        public DummyData()
        {
            ...
            Collection.Add(new CardData() { Column = "Requested", Lane = "lane1", Size = "XXL", CreationTime = DateTime.MinValue, Duration = 200, Number = 99999, Assignee = "User1", Description = "This also is something requested ;)" });
