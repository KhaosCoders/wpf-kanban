...
namespace WpfApp1
{
    public class DummyData
    {
        ...
        public DummyData()
        {
            ...
            Collection.Add(new CardData() { Column = "Backlog", Lane = "lane1", Number=1, Assignee = "User1", Description = "Something in the backlog Part 1/2", TitleColor = Colors.LightBlue });
            ...
            Collection.Add(new CardData() { Column = "Design", Lane = "lane1", Number = 4, Assignee = "User1", Description = "We're designing the hell out of this", TitleColor = Colors.LightBlue });
            Collection.Add(new CardData() { Column = "Doing", Lane = "lane2", Number = 5, Assignee = "User2", Description = "Something we're working on right now", TitleColor = Colors.LightGreen });
            Collection.Add(new CardData() { Column = "Doing", Lane = "lane2", Number = 6, Assignee = "User2", Description = "The other thing we're working on right now", TitleColor = Colors.LightBlue });
