...
namespace WpfApp1
{
    public class DummyData
    {
        ...
        public DummyData()
        {
            ...
            Collection.Add(new CardData() { Column = "Backlog", Lane = "lane1", CreationTime=DateTime.Now, Duration=30, Number =1, Assignee = "User1", Description = "Something in the backlog Part 1/2", TileColor = Colors.Yellow });
            ...
            Collection.Add(new CardData() { Column = "Design", Lane = "lane1", CreationTime = DateTime.UtcNow, Duration = 650, Number = 4, Assignee = "User1", Description = "We're designing the hell out of this", TileColor = Colors.LightBlue });
            Collection.Add(new CardData() { Column = "Doing", Lane = "lane2", CreationTime = DateTime.Parse("12.02.2019 08:00"), Duration = 1500, Number = 5, Assignee = "User2", Description = "Something we're working on right now", TileColor = Colors.LightGreen });
            Collection.Add(new CardData() { Column = "Doing", Lane = "lane2", CreationTime = DateTime.Now, Duration = 10000, Number = 6, Assignee = "User2", Description = "The other thing we're working on right now", TileColor = Colors.LightBlue });
